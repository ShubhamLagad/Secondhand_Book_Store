 ...
 * Generated at: 2022-05-01 12:28:34 UTC
...
public final class singleBookView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    while(rs6.next()){
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        .btn-secondary,.btn-dark {\r\n");
 ...
 out.print(countCart); 
      ...
      out.write("           <div class=\"row text-capitalize\">\r\n");
      out.write("               <div class=\"col-sm-6\">\r\n");
      out.write("                   <div class=\"text-center\">\r\n");
      out.write("                        <img class=\"shadow-lg rounded\" src=\"../images/Book/");
 out.print(rs.getString("image")); 
      out.write("\" alt=\"...\" width=\"300px\" height=\"400px\">\r\n");
      out.write("                   </div>\r\n");
      out.write("                   <div class=\"text-center my-4\">\r\n");
      out.write("                    <a href=\"./orderAddress.jsp?book_no=");
 out.print(book_no); 
      out.write("&&price=");
 out.print(Integer.parseInt(rs.getString("selling_price"))); 
      out.write("\" class=\"btn btn-danger col-4 shadow\" id=\"buynow\">Buy Now</a>\r\n");
      out.write("                    \r\n");
      out.write("                    ");
 if(request.getParameter("status2")!=null || rs3.next()){
                       
      out.write("\r\n");
      out.write("                        <a href=\"./myCart.jsp\" id=\"cartBtn\" class=\"btn btn-warning col-4 shadow\">\r\n");
      out.write("                        <i class=\"fa fa-shopping-cart mr-1\"></i>Go to Cart\r\n");
      out.write("                        </a>\r\n");
      out.write("                       ");
      ...
      out.write("\r\n");
      out.write("                            <a href=\"./controller/addToCart.jsp?book=");
out.print(book_no);
      out.write("\" id=\"cartBtn\" class=\"btn btn-warning col-4\">\r\n");
      out.write("                            <i class=\"fa fa-shopping-cart mr-1\"></i>Add to Cart\r\n");
      out.write("                        </a>\r\n");
      out.write("                       ");
...
out.print(Integer.parseInt(rs.getString("original_price"))-Integer.parseInt(rs.getString("selling_price")));
      ...
      out.write("                                    </small>\r\n");
      out.write("                                </p>\r\n");
      out.write("                         <p class=\"card-text\"><small>Free delivery</small></p>\r\n");
      out.write("                        <p class=\"text-danger\">Original Price : <i class=\"fa fa-rupee\"></i> ");
out.print(rs.getString("original_price")); 
      out.write("</p>\r\n");
      out.write("                      <p class=\"card-title\">Auther : ");
out.print(rs.getString("auther_name")); 
      out.write("</p>\r\n");
      out.write("                      <p class=\"card-text\">Category : ");
out.print(rs.getString("category")); 
      out.write("</p>\r\n");
      out.write("                      <p class=\"card-text\">Language : ");
out.print(rs.getString("book_language")); 
      out.write("</p>\r\n");
      out.write("                      <p class=\"card-text\">Purchase Date : ");
out.print(rs.getString("purchase_date")); 
      out.write("</p>\r\n");
      out.write("                      <p class=\"card-text\">Upload Date : ");
out.print(rs.getString("upload_date")); 
      out.write("</p>\r\n");
      out.write("                      <p class=\"card-text\">Condition :");
...
out.print(rs.getString("description")); 
      ...
      out.write("\r\n");
      out.write("                        <p class=\"card-text\"><Strong>Owner Details : </Strong><p>Name : ");
out.print(res.getString("name")); 
      out.write("</p><p>Email : <span  class=\"text-lowercase\">");
out.print(res.getString("email")); 
      out.write("</span></p><p>Mobile No : ");
out.print(res.getString("contactno")); 
      ...
      out.write("\r\n");
      out.write("                        <hr>\r\n");
      out.write("                        <p>Give your review</p>\r\n");
      out.write("                        <p>Price would be :  <button id=\"priceCond\" class=\"btn btn-danger mx-2\" onclick=\"sendPrice('To high')\">To high</button><button id=\"priceCond2\" class=\"btn btn-success\" onclick=\"sendPrice('Cheapest')\">Cheapest</button>\r\n");
      out.write("                        <input type=\"hidden\" id=\"bno\" name=\"book\" value=\"");
out.print(book_no); 
      out.write("\">\r\n");
      out.write("                        <input type=\"hidden\" id=\"owner\" value=\"");
out.print(res.getString("email")); 
      out.write("\"></p>\r\n");
      out.write("                        <script>\r\n");
      out.write("                            var request;\r\n");
      out.write("                            function sendPrice(str) {\r\n");
      out.write("                                var bno = document.getElementById(\"bno\").value;\r\n");
      out.write("                                var owner = document.getElementById(\"owner\").value;\r\n");
      out.write("                                var url = \"./controller/priceSuggetion.jsp?price=\"+str+\"&bno=\"+bno+\"&owner=\"+owner;\r\n");
      out.write("                        \r\n");
      ...
      out.write("                                   alert(\"You review will be recorded!\");\r\n");
      out.write("                                   document.getElementById(\"priceCond\").disabled = true;\r\n");
      out.write("                                   document.getElementById(\"priceCond2\").disabled = true;\r\n");
      out.write("                                }\r\n");
      out.write("                            }  \r\n");
      out.write("                        </script>\r\n");
      out.write("                    </div>\r\n");
