        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                    ...
                    <p data-aos="fade-up" data-aos-delay="500">The people who throw away their old books are to give them to someone who needs them without throwing them away, for this is the best platform. Thank you.
                    </p>
                    <p  data-aos="fade-up" data-aos-delay="500">We do not charge for delivery. But some charges may apply for maintaining our websites.</p>
                    ...
                    <div id="carouselExampleInterval" data-aos="fade-up" data-aos-delay="300" class="carousel slide "
                        ...
                        <div class="carousel-item active" data-interval="2000">
                            ...
                            <div class="carousel-item" data-interval="2000">
                                <div class="d-block w-100 text-center">
                                    <h4 class="text-capitalize"><%out.println(res.getString("name"));%></h4>
                                    <hr>
            ...
            <div class="row">
                <div class="ml-auto col-lg-5 col-md-6 col-12">
                    ...
                    <div class="contact-form webform" data-aos="fade-up" data-aos-delay="400">
                      ...
                      <p>Sinhgad Institute of Management,<br> Vadgaon Budruk, Pune, Maharashtra</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                             ...
                             <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input pattern="*[0-9]" maxlength="6" minlength="6" type="text" name="regPincode" class="form-control" id="pincode"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input pattern="*[0-9A-Za-z ]" type="text" name="regAddress" class="form-control" id="address"
