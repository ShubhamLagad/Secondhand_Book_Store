...
<%
    ...
    String address = "";
    if(request.getParameter("postalAddress")!=null){
        address = request.getParameter("postalAddress")+" "+request.getParameter("city")+" "+request.getParameter("pinCode");
    }else{
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion" id="accordionExample">
                            ...
                            <div class="card-body text-center">
                                ...
                                <form action="./controller/orders.jsp" method="get">
                                    <div class="text-center mt-4">
                                        ...
                                        <input type="hidden" name="address" value="<%out.print(address);%>">
                        ...
                        <div id="collapseTwo" class="collapse bg-light  mx-4" aria-labelledby="headingTwo"
                            data-parent="#accordionExample">
                            <form action="./controller/orders.jsp" method="get" class="p-4">
                                <div class="container">
