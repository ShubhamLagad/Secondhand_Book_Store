...
%>
    ...
    <!-- CONTACT -->
    <section>
        <div class="jumbotron my-4 px-2 text-capitalize">
                        ...
                        <td><% out.print(rs.getString("status")); %></td>
                         <td>
                            ...
                            while(re.next()){
                                ...
                                %>
                                <label class="text-success"><%out.print(re.getString("price"));%></label>
                                <% 
                                }else{
                                    %>
                                <label class="text-danger"><%out.print(re.getString("price"));%></label>
                                <%
                                }
                            }
                            %>
