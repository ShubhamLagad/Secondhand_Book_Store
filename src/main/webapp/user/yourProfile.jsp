                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                               <a class="dropdown-item" href="./yourProfile.jsp"><i class="fa fa-user"></i> Your
                                ...
                                <a class="dropdown-item" href="./bankAccount.jsp"><i class="fas fa fa-plus"></i> Add
                                    ...
                                    Account</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" data-toggle="modal" href="#walletModel"><i class="fa fa-bank"></i> Your Wallet</a>
                                <div class="dropdown-divider"></div>
                ...
                <img src="../images/profile.png" class="card-img-top">
                    ...
                    <div class="col-sm-6">
                        <div class="card-body text-left text-capitalize">
                            <h5 class="card-title"><% out.print(rs.getString("name")); %></h5>
                            <p class="card-text">Email : <span class="text-lowercase"><% out.print(rs.getString("email")); %></span></p>
                            <p class="card-text">Gender : <% out.print(rs.getString("gender")); %></p>
                            <p class="card-text">Contact No. : <% out.print(rs.getString("contactNo")); %></p>
                            <p class="card-text">City : <% out.print(rs.getString("address")); %></p>
                        </div>
                        <button class="btn btn-secondary col-10 mt-5 shadow" data-toggle="modal"
                        data-target="#userUpdateModel">Edit Profile</button>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalCenterTitle">Edit Your Profile</h3>
            ...
            <div class="modal-body">
                <form id="regForm" action="./controller/updateProfile.jsp" method="post">
                    <div class="form-group">
                        <label>Your Name</label>
                        <input pattern="*[A-Za-z ]" type="text" class="form-control" name="updateName" id="regName"
                            placeholder="Enter your name" value="<% out.print(rs.getString("name")); %>" required>
                    </div>
                    <div class="form-group">
                        <label>Email address</label>
                        <input type="email" class="form-control" name="updateEmail" id="regEmail" aria-describedby="emailHelp"
                            placeholder="Enter email" value="<% out.print(rs.getString("email")); %>" required>
                    ...
                    <div class="form-group">
                        <label>Gender</label>
                        <select class="form-control" name="updateGender" id="gender" required>
                            <option selected><% out.print(rs.getString("gender")); %></option>
                            <option>Male</option>
                    ...
                    <div class="form-group">
                        ...
                        <input pattern="*[0-9]" maxlength="10" minlength="10" type="text" class="form-control" id="contactNo"
                            name="updateContactNo" placeholder="Enter mobile no" value="<% out.print(rs.getString("contactNo")); %>" required>
                    </div>
                    <div class="form-group">
                        <label for="address">Address</label>
                        <input pattern="*[A-Za-z ]" type="text" name="updateAddress" class="form-control" id="address"
                            value="<% out.print(rs.getString("address")); %>" required>
                    </div>
                    <div class="form-group text-center mt-3">
                        <button type="submit" class="btn btn-primary col-sm-8" id="update">Update</button>
                    </div>
                </form>
            </div>
        </div>
