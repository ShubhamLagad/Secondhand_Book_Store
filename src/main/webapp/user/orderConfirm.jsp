                    ...
                    <ul class="navbar-nav">
                        <li class="nav-link nav-item mr-lg-2 dropdown" id="navbarSupportedContent">
                            <a class="dropdown-toggle text-dark" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <i class="fa fa-user-circle fa-2x" style="font-size:x-large;"> <span class="text-capitalize"></span>Hi, <%
        ...
        <div class="jumbotron m-4 text-center">
            ...
            <hr>
                <div class="border-dark m-3">
                    ...
                    <p class="card-text text-capitalize"><%out.print(rs.getString("address"));%></p>
              </div>
            ...
            <div class="text-center">
                <a data-toggle="modal" href="./myOrders.jsp" class="text-success">View Orders </a>
            </div>
        </div>
    </section>
                ...
                <form action="./controller/changeAddress.jsp" method="post">
                    ...
                    <div class="row" id="addressRow">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" name="pincode" id="pincode" maxlength="6" minlength="6" placeholder="Pin code">
                        </div>
