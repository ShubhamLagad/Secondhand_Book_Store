    ...
    <section>
        <div class="container p-2 shadow-lg rounded">
            <form class="p-3 rounded" id="sellForm" action="./controller/uploadBook.jsp" method="get"
                ...
                <h3 class="mb-4 text-dark rounded p-3 head-shadow">Upload Your Books</h3>
                <div class="form-row shadow p-3 rounded">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" onchange="checkPrice()" name="sellingPrice" id="sellingPrice"
                            placeholder="Enter Price" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control" id="description" name="description"
                            placeholder="Enter Description" maxlength="40" required></textarea>
                    </div>
                    <div class="form-group col-md-6">
